...
export type View = 'dashboard' | 'subjects' | 'students' | 'enrollment' | 'activities' | 'batch' | 'audit' | 'reports' | 'implementacoes' | 'settings' | 'skills' | 'manual' | 'canvas' | 'copy' | 'student-profile';
